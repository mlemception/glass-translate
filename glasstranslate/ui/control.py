...
def _ensure_resources() -> bool:
    ...
    development; in a source checkout it is built once here when missing.  The frozen exe must
    ship it.
    """
    try:
    ...
    try:
        from tools.build_resources import build  # noqa: WPS433 - dev-only dependency

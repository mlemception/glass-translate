# GlassTranslate — technical reference

How it works, how to build it, and how to extend it. If you just want to install and use the
app, start at the [README](../README.md).

## Contents

| Section | What's in it |
|---|---|
| [Stack and why](#stack-and-why) | Every dependency and the reason it was picked |
| [Install](#install) | Running from source, CUDA extras |
| [Portable bundle](#portable-bundle-no-installer-no-python-no-network) | The zip layout, the `portable.txt` rule, building it |
| [Translation models](#translation-models) | On-disk layouts, Sugoi v4, Argos packages |
| [Running](#running) | The two-window model, hotkeys, settings file |
| [Manga mode and typesetting](#manga-mode-and-typesetting) | Block grouping, bubble detection, erasing, lettering, the quality sidecar |
| [Demo](#demo-no-gui-needed) | Headless runs, synthetic images, timings |
| [Tests](#tests) | Both suites and why they are separate |
| [Adding a translation backend](#how-to-add-a-translation-backend) | The `Translator` contract |
| [Known limitations](#known-limitations) | Where it breaks and why |

**Deeper references**

| Document | Covers |
|---|---|
| [ARCHITECTURE.md](ARCHITECTURE.md) | Full module contracts |
| [GLASS_DESIGN.md](GLASS_DESIGN.md) | Binding design contract for the control window |
| [../renderer/MODELS.md](../renderer/MODELS.md) | Quality-renderer weights: provenance, pinned revisions, licences |
| [../renderer/PROTOCOL.md](../renderer/PROTOCOL.md) | Sidecar wire protocol and security notes |
| [perf/](perf/) | Benchmarks and baselines |
| [plans/](plans/) | Design plans per feature batch |
